<?php include('inc/header2.php'); ?>
		...
		<?php
 	$sql="SELECT * FROM message_teacher WHERE msg_id = '$_REQUEST[msg_id]'";
...
?>
  ...
  <a href="javascript:message_delete(<?php echo $data['msg_id']; ?>,<?php echo $data['msg_em_id']; ?>)"> Delete </a> || 
...
<center>
	...
	<input type="hidden" name="reply_by" value="teacher">
	<input type="hidden" name="em_id" value="<?php echo $_REQUEST['em_id'];?>">
	</form>
</center>
